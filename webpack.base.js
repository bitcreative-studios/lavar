 ...
 * via:https://github.com/notable/notable/blob/master/webpack.base.js
 */
...
function base(options) {
  //TODO: Maybe we don't need to define multiple webpack configs //URL: https://github.com/electron-userland/electron-webpack/issues/290
    ...
    plugins: [
      ...
      new BundleAnalyzerPlugin({
        ...
        reportFilename: path.join(
          __dirname,
          `webpack.report.${options.target}.html`
        ),
        openAnalyzer: false,
        logLevel: "silent",
      }),
